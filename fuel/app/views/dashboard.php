...
<body>
	...
	<div class="container">
		...
		<!-- 28日間の記録 -->
		<section class="section display" id="display-section">
			<?php echo $display_view; ?> 
		</section>

		<!-- 設定 -->
		<section class="section setting" id="setting-section">
	...
	<script>
		...
		const actionsVM = new ActionsViewModel();     //行動一覧のビューモデル
		const displayVM = new DisplayViewModel();     //今日の行動一覧のビューモデル
		const todayVM = new TodayActionsViewModel();  //28日間の記録のビューモデル
		const settingVM = new SettingViewModel();     //設定画面のビューモデル
