...
class Model_Records extends \Model_Crud
{
   ...
   public static function edit_record($data) //$dataはnameとfrequencyとid(action)とbefore_frequency
   {
        ...
        //今日予定してるのは明日から反映するか、statusで分けるか、、、
        //とりあえず今日予定分は明日から頻度が反映
        //今日の予定は変えられないことにする、今日の予定に入ってるやつは次回から変更可能(新しく今日の予定にインサートした場合も変えられない)
        //今日の予定にある->next_at変更
        //今日の予定じゃない->next_at変更->next_at今日ならレコードインサート
